    ...
    <head>
        ...
        <script>
            function ALogin()
            {
                ...
                else if (apasswd.length < 6 || apasswd.length > 10)
                {
                ...
                <div class="row">
                    <div class="col-md-6 col-sm-12 forms-right-icons">
                        <div class="section-heading">
                            ...
                            <p class="subheading">What not an Admin can do login to get complete access to all details .
                            </p>
                        </div>
                        <div class="row">
                        ...
                        <div class="form-box">
                            <div class="form-top">
                                <div class="form-top-left">
                                    <h3>Login</h3>
                                    <p>Enter Admin Username and password to log in:</p>
                                </div>
                            ...
                            <div class="form-bottom">
                                <form role="form" action="AdminLogin" class="login-form" method="post" onsubmit="return ALogin()">
                                    <div class="input-group form-group">
                                        <span class="input-group-addon" id="basic-addon1"><i class="fa fa-user"></i></span>
                                        <input type="text" name="aname" class="form-control aname" placeholder="Admin Username" aria-describedby="basic-addon1">
                                    </div>
                                    <div class="input-group form-group">
                                        <span class="input-group-addon" id="basic-addon1"><i class="fa fa-unlock"></i></span>
                                        <input type="password" name="apasswd" class="form-control apasswd" placeholder="Password" aria-describedby="basic-addon1">
                                    </div>
